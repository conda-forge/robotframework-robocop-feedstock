...
Once the `conda-forge` channel has been enabled, `robotframework-robocop, robotframework-robocop-with-all, robotframework-robocop-with-mcp` can be installed with `conda`:

```
conda install robotframework-robocop robotframework-robocop-with-all robotframework-robocop-with-mcp
```

or with `mamba`:

```
mamba install robotframework-robocop robotframework-robocop-with-all robotframework-robocop-with-mcp
```
